...
// =========================
{
  ...
  key: "HEATER-INSTALL-EXTERNAL-HOTTUB",
...
{
  groupKey: OptionGroupKey.HEATER_INSTALLATION,
  key: "HEATER-INSTALL-INTEGRATED-HOTTUB",
...
// =========================
{
  ...
  images: ["/placeholders/material-1.png"],
  attributes: {
    installationType: HeaterInstallationType.INTEGRATED,
...
// --- External wood 20kW ---
{
  ...
  attributes: {
    installationType: HeaterInstallationType.EXTERNAL,
    type: HeatingType.WOOD,
    heatingTime: null,
    power: "20kW",
    voltage: null,
...
// --- Electric ---
{
  ...
  attributes: {
    ...
    installationType: HeaterInstallationType.BOTH,
